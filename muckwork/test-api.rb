...
class MuckworkAPITest < Minitest::Test
	...
	def test_person_in_table
		## this is a test of peeps.person_in_table function
		qry("peeps.person_in_table(1, 'muckwork.clients')")
		assert_equal({}, @j)
		qry("peeps.person_in_table(2, 'muckwork.clients')")
		assert_equal({id: 1}, @j)
		qry("peeps.person_in_table(2, 'duckwork.clients')")
	...
	def test_get_manager
		...
		r = {id:1, person_id:1, name:'Derek Sivers', email:'derek@sivers.org', address:'Derek', company:'50POP LLC', city:'Singapore', state:nil, country:'SG'}
		assert_equal r, @j
	...
	def test_get_client
		...
		r = {:id=>2, :person_id=>3, :currency=>'GBP', :name=>'Veruca Salt', :email=>'veruca@salt.com', :address=>'Veruca', :company=>'Daddy Empires Ltd', :city=>'London', :state=>'England', :country=>'GB', :balance=>{currency: 'GBP', amount:100}}
		assert_equal r, @j
	...
	def test_update_client
		...
		r = {:id=>2, :person_id=>3, :currency=>'EUR', :name=>'Veruca Darling', :email=>'veruca@salt.com', :address=>'Veruca', :company=>'Daddy Empires Ltd', :city=>'London', :state=>'England', :country=>'BE', :balance=>{:currency=>'EUR', :amount=>136.07}}
		assert_equal r, @j
	...
	def test_get_worker
		...
		r = {:id=>2, :person_id=>5, hourly_rate:{currency:'THB',amount:350}, :name=>'Oompa Loompa', :email=>'oompa@loompa.mm', :address=>'Oompa Loompa', :company=>nil, :city=>'Hershey', :state=>'PA', :country=>'US'}
		assert_equal r, @j
	...
	def test_create_worker
		...
		r = {:id=>4, :person_id=>8, :hourly_rate => {currency:'USD',amount:10}, :name=>'Yoko Ono', :email=>'yoko@ono.com', :address=>'Ono-San', :company=>'yoko@lennon.com', :city=>'Tokyo', :state=>nil, :country=>'JP'}
		assert_equal r, @j
	...
	def test_update_worker
		...
		r = {:id=>2, :person_id=>5, :hourly_rate=>{currency:'THB',amount:350}, :name=>'Oompa Wow', :email=>'oompa@loom.pa', :address=>'Oompa Loompa', :company=>'cash', :city=>'Hershey', :state=>'PA', :country=>'US'}
		assert_equal r, @j
	...
	def test_client_get_projects
		...
		assert_equal [2,4], @j.map {|p| p[:id]}.sort
	end
